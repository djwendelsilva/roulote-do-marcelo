...
const productArt: Record<string, Record<string, { image: string; position: string; size?: string }>> = {
  ...
  "Cervejas & sidra": {
    ...Object.fromEntries(["Imperial Sagres", "Imperial Sagres média", "Imperial Sagres grande"].map((name) => [name, { image: "/beverages/real/imperial-sagres-disposable-plastic-cup.png", position: "center", size: "cover" }])),
