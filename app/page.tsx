...
const menu: Record<string, Item[]> = {
  "Hambúrgueres": [
    ...
    { name: "Thor", price: "22,00 €", description: "3 hambúrgueres de vitela, bife de vitela, 2 salsichas, 2 ovos, bife de frango, bife de bifana, queijo, bacon, milho, cebola, fiambre, salada, molhos especiais e batata palha." },
    ...
    { name: "Duplo", price: "9,00 €", description: "Hambúrguer duplo." },
    { name: "Triplo", price: "12,00 €", description: "Hambúrguer triplo." },
  ...
  "Porções & batatas": [
    ...
    { name: "Suprema", price: "10,00 €", description: "Batata, bacon, frango e queijo cheddar. Porção para três pessoas." },
  ],
  "Kebabs": [
  ...
  "Cervejas & sidra": [
    ...
    { name: "Heineken mini", price: "2,00 €", description: "Heineken mini, garrafa de vidro." },
...
const productArt: Record<string, Record<string, { image: string; position: string; size?: string }>> = {
  ...
  "Cervejas & sidra": {
    ...
    "Heineken mini": { image: "/beverages/black/heineken.png", position: "center", size: "contain" },
