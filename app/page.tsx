...
const menu: Record<string, Item[]> = {
  ...
  "Cervejas & sidra": [
    ...
    { name: "Sagres mini", price: "1,50 €", description: "Cerveja Sagres mini em garrafa de vidro." },
    { name: "Sagres média", price: "2,00 €", description: "Cerveja Sagres média em garrafa de vidro." },
...
const productArt: Record<string, Record<string, { image: string; position: string; size?: string }>> = {
  ...
  "Cervejas & sidra": {
    ...
    ...Object.fromEntries(["Sagres mini", "Sagres média"].map((name) => [name, { image: "/beverages/real/sagres-glass.jpg", position: "center", size: "contain" }])),
    "Super Bock mini": { image: "/beverages/real/super-bock-mini-glass.jpg", position: "center", size: "contain" },
    "Super Bock média": { image: "/beverages/real/super-bock-media-glass.jpg", position: "center", size: "contain" },
    "Heineken": { image: "/beverages/real/heineken.jpg", position: "center", size: "contain" },
    "Corona": { image: "/beverages/real/corona-glass.png", position: "center", size: "contain" },
