...
const menu: Record<string, Item[]> = {
  ...
  "Cervejas & sidra": [
    { name: "Imperial Sagres", price: "1,30 €", description: "Cerveja Sagres." },
    { name: "Imperial Sagres média", price: "1,60 €", description: "Cerveja Sagres, tamanho médio." },
    { name: "Imperial Sagres grande", price: "3,50 €", description: "Cerveja Sagres, tamanho grande." },
...
const productArt: Record<string, Record<string, { image: string; position: string; size?: string }>> = {
  ...
  "Refrigerantes & águas": {
    "Coca-Cola": { image: "/beverages/real/coca-cola.jpg", position: "center", size: "contain" },
    "Fanta": { image: "/beverages/real/fanta-laranja.png", position: "center", size: "contain" },
    "Guaraná Antarctica": { image: "/beverages/real/guarana.jpg", position: "center", size: "contain" },
    "Sprite": { image: "/beverages/real/sprite.jpg", position: "center", size: "contain" },
    "Fuze Tea Pêssego": { image: "/beverages/real/fuze-tea-pessego.jpg", position: "center", size: "contain" },
    "Lipton Ice Tea Limão": { image: "/beverages/real/lipton-limao.jpg", position: "center", size: "contain" },
    "Lipton Ice Tea Pêssego": { image: "/beverages/real/lipton-pessego.jpg", position: "center", size: "contain" },
    "Lipton Ice Tea Laranja & Manga": { image: "/beverages/real/lipton-laranja-manga.png", position: "center", size: "contain" },
    "Água Castelo": { image: "/beverages/real/agua-castello.jpg", position: "center", size: "contain" },
    "Sumol Laranja": { image: "/beverages/real/sumol-laranja.jpg", position: "center", size: "contain" },
    "Sumol Ananás": { image: "/beverages/real/sumol-ananas.jpg", position: "center", size: "contain" },
    "7UP": { image: "/beverages/real/7up.jpg", position: "center", size: "contain" },
    "Red Bull": { image: "/beverages/real/red-bull.png", position: "center", size: "contain" },
    "Água 500 ml": beverageArt.water500,
    "Água 1,5 L": beverageArt.water1500,
    "Água das Pedras": { image: "/beverages/real/agua-pedras.png", position: "center", size: "contain" },
    "Água Tónica Schweppes": { image: "/beverages/real/schweppes.png", position: "center", size: "contain" },
  },
  "Cervejas & sidra": {
    ...Object.fromEntries(["Imperial Sagres", "Imperial Sagres média", "Imperial Sagres grande", "Sagres mini", "Sagres média"].map((name) => [name, { image: "/beverages/real/sagres.jpg", position: "center", size: "contain" }])),
    ...Object.fromEntries(["Super Bock mini", "Super Bock média"].map((name) => [name, { image: "/beverages/real/super-bock.jpg", position: "center", size: "contain" }])),
    "Heineken": { image: "/beverages/real/heineken.jpg", position: "center", size: "contain" },
    "Corona": { image: "/beverages/real/corona.jpg", position: "center", size: "contain" },
    "Somersby Maçã mini": { image: "/beverages/real/somersby.jpg", position: "center", size: "contain" },
    "Somersby Maçã média": { image: "/beverages/real/somersby.jpg", position: "center", size: "contain" },
  },
  "Whisky & licores": {
    "Red Label": { image: "/beverages/real/red-label.jpg", position: "center", size: "contain" },
    "Grant’s": { image: "/beverages/real/grants.jpg", position: "center", size: "contain" },
    "Beirão": { image: "/beverages/real/beirao.jpg", position: "center", size: "contain" },
  },
